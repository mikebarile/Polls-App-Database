...
AnswerChoice.create!(text: "Justice", question_id: 1)
AnswerChoice.create!(text: "Justice", question_id: 2)
AnswerChoice.create!(text: "Mike", question_id: 1)
AnswerChoice.create!(text: "Mike", question_id: 2)
